	          ...
	          if ( $controls ) {
	            ...
	            if ( $content ) {
	              ...
	              foreach ( $controls as $control ) { ?>
	                  ...
	                  ?>
	                  <p class="<?php echo esc_attr( $control->id ); ?> description description-thin">
	                    <?php if ( $label ) : ?>
												<label for="edit-menu-item-<?php echo esc_attr( $control->id ); ?>-{{ data.menu_item_id }}">
													<?php esc_html( $label ); ?><br />
											<?php endif; ?>
													<input type="text" id="edit-menu-item-<?php echo esc_attr( $control->id ); ?>-{{ data.menu_item_id }}"
														class="widefat edit-menu-item-<?php echo esc_attr( $control->id ); ?>"
														name="menu-item-<?php echo esc_attr( $control->id ); ?>" />
											<?php if ( $label ) : ?>
												</label>
											<?php endif; ?>
